            ...
            <div className="space-y-3 max-h-[280px] overflow-y-auto pr-2">
              {comments.slice(0, showAll ? comments.length : 2).map((c) => (
                ...
                >
                  ...
                  {/* ✅ Show only if logged-in user is the comment owner */}
                  {c.user?._id === loggedUser?.id && (
